(function ($) {
    ...
    //汉化 (这里本想默认图标,但是没有办法获取,不知道为什么,还是在页面写icon)
    $.fn.formValidation.DEFAULT_OPTIONS['zh_CN'] ={
        locale:'zh_CN',
        message:'请输入有效值'
    }; 
    $.extend($.fn.formValidation.DEFAULT_OPTIONS, $.fn.formValidation.DEFAULT_OPTIONS['zh_CN']);
}(jQuery));
