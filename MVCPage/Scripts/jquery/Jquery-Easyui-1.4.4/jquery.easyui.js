...
_a4d(this,q);
}},currentText:"Today",cleanText:"Clean",cleanText:"Clean",closeText:"Close",okText:"Ok",buttons:[{text:function(_a62){
...
text: function (_sgw989) {
return $(_sgw989).datebox("options").cleanText;
}, handler: function (_sgw990) {
$(_sgw990).combo('setValue', '').combo('setText', '');
$(this).closest("div.combo-panel").panel("close");
}}],formatter:function(date){
